...
public class ROOM_CHANGE_INFO_REQ extends game.network.game.GamePacketREQ
{
	Room r;
	ModesEnum type;
	String leader_name;
	int map, weapon;
	boolean specialMode, autorized, camp;
	@Override
	public void readImpl()
	{
		...
		if (r != null && r.rstate == RoomState.READY && r.LIDER == client.pId)
		{
			...
			if (specialMode = r.isSpecialMode()) 
			{
				r.aiCount = ReadC();
				r.aiLevel = ReadC();
			}
	...
	public void runImpl()
	{
		if (autorized)
		{
			...
			ROOM_CHANGE_ROOMINFO_ACK sent1 = new ROOM_CHANGE_ROOMINFO_ACK(r, leader_name, specialMode); sent1.packingBuffer();
