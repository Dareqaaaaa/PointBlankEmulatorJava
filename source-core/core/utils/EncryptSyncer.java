...
public class EncryptSyncer
{
    ...
    public String aesEncryptionAlgorithem;
	...
	public void MD5file(String dist) 
	{
		try
		{
	...
	public char[] hexCodes(byte[] text)
	{
	...
	public int SHA1_int32(String msg)
	{
		int result = 0;
		try
		{
    ...
    public String getHWID()
    {
        ...
        try
        {
	        ...
	        {
	            s += Integer.toHexString((md5[i] & 255) | 0x300).substring(0, 3);
	            if (i != md5.length - 1)
	            	 s += "-";
	        }
        }
    ...
    static final EncryptSyncer INSTANCE = new EncryptSyncer();
    public static EncryptSyncer gI()
    {
    	return INSTANCE;
    }
}